...
export interface Page {
  ...
  heroVariant?: ('home' | 'simple' | 'minimal') | null;
  content?: {
    root: {
      type: string;
      children: {
...
export interface Service {
  ...
  priceUnit?: ('hour' | 'day' | 'month' | 'project' | 'one-time') | null;
  features?:
    | {
        feature: string;
        id?: string | null;
...
export interface Category {
  ...
  slug: string;
  description?: string | null;
  icon?: ('briefcase' | 'chart' | 'users' | 'target' | 'lightbulb' | 'shield' | 'globe' | 'building') | null;
  updatedAt: string;
  createdAt: string;
}
/**
